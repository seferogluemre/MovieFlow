...
import { MoreHorizontal, Search, Eye, Trash, Star, Clock, Pencil } from "lucide-react"
          ...
          <TableBody>
            {filteredLibrary.map((movie) => (
              <TableRow key={movie.id}>
                ...
                <TableCell>{movie.lastWatched}</TableCell>
