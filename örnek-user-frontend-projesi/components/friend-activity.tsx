              ...
              <div className="space-y-1 flex-1">
                <p className="text-sm">
                  ...
                  {activity.type === "review" && (
                    <>
                      rated <span className="font-medium">{activity.movie}</span>{" "}
                  ...
                  {activity.type === "watched" && (
                    <>
                      watched <span className="font-medium">{activity.movie}</span>
                    </>
                  )}
                  {activity.type === "comment" && (
                    <>
                      commented on <span className="font-medium">{activity.movie}</span>
                    </>
                  )}
                </p>
                {activity.type === "comment" && <p className="text-xs text-muted-foreground">"{activity.comment}"</p>}
